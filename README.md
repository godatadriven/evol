...
A working example of something silimar to what is depicted above is show below. You can also find this code as an example in the `/examples/simple_nonlinear.py`. 
